...
export class SpiListCoupleDeQualificatif {
    ...
    deleteQualificatif(idQualificatif: number) {   
        return fetch('http://app-aead2b86-a4bb-4a14-9b97-cd0d09d78ae6.cleverapps.io/qualificatif/supprimerParid', {
            ...
            location.href = '/ListQualifiactifs';
        }
        ).catch((error) => {
    ...
    render() {
        if (this.coupledequalificatifs != null) {
            return (
                <div class="container">
                <br></br><br></br>
                <h1 class="title">Les couples de qualificatifs existants</h1>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-content">
                                                ...
                                                <footer class="card-footer">
                                                    <a id="edit" class="card-footer-item" href={`/editQ/${item.idQualificatif}`}>Modifier</a>
